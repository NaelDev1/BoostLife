...
set => SetValue(ClickCommandProperty, value);
                        ...
                        {
get => (object)GetValue(ClickCommandParametersProperty);
set => SetValue(ClickCommandParametersProperty, value);
                                }

                                static readonly DependencyProperty ClickCommandParametersProperty =
                                DependencyProperty.Register(nameof(ClickCommandParameters), typeof(object), typeof(NavBarButton));
                                }
